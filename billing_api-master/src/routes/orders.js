...
router.put("/updateOrders/:orderTableId/:orderId", async (req, res) => {
  try {
...
router.put("/updateOrderTablePrice/:orderTableId", async (req, res) => {
  try {
...
router.get("/getOneOrders/:orderTableId/:orderId", async (req, res) => {
  try {
...
router.get("/getOneOrders/:id", async (req, res) => {
  try {
